...
public class Cloudlet {
     ...
     * In byte = program + input data size
     */
    ...
    /**
     * The num of Pe required executing this job.
     */
     ...
     * With new functionalities, such as CANCEL, PAUSED and RESUMED, this attribute only stores the latest execution
     * time.
     * Previous execution time is ignored.
     */
     ...
     * The required files.
     */
    private List<String> requiredFiles;   // list of required filenames

    // Data cloudlet
    /**
     * Allocates a new Cloudlet object.
     * The Cloudlet length, input and output file sizes should be greater than or equal to 1.
    ...
    public Cloudlet(
        ...
        // migrated to others.
        // Hence, to reduce memory consumption, set the size of this ArrayList to be less than the default one.
     ...
     * This Cloudlet length is calculated for one Pe only <tt>not</tt> the total length.
     *
     * @param cloudletLength the length or size (in MI) of this Cloudlet to be executed in a
     *                       CloudResource
    ...
    /**
     * Gets the class type or priority of this Cloudlet for scheduling on a resource.
     *
     * @return class type of this cloudlet
     * @pre $none
     * @post $none
     */
     ...
     * NOTE: The Cloudlet length is computed only for one Pe for simplicity. <br>
     ...
     * The layout of this history is in a readable table column with <tt>time</tt> and <tt>description</tt> as headers.
     *
     ...
     * This method is used by ResCloudlet class when an application is decided to cancel or to move this Cloudlet into
    ...
    public boolean isFinished() {
        ...
        // if a result is 0 or -ve, then this Cloudlet has finished
        final long finish = resList.get(index).finishedSoFar;
     ...
     * It is <tt>VERY</tt> important to set the user ID, otherwise this Cloudlet will not be executed in a
     * CloudResource.
     *
     ...
     * <b>NOTE:</b> With new functionalities, such as being able to cancel / to pause / to resume this Cloudlet, the
     * execution start time only holds the latest one.
     * Meaning, all previous execution start time is ignored.
     *
     ...
     * These parameters are set by the CloudResource before departure or sending back to the original Cloudlet's owner.
     *
    ...
    /**
     * Returns the time the Cloudlet actually runs.
     *
    ...
    public boolean addRequiredFile(final String fileName) {
        ...
        // then check whether the filename already exists or not
