...
import org.infrastructureProvider.entities.DatacenterCharacteristics;
import org.infrastructureProvider.entities.Vm;

import java.util.*;

/**
 * DatacenterBroker represents a broker acting on behalf of a user.
 * It hides VM management, as vm creation, submission of cloudlets to this VM and destruction of VMs.
 *
...
public class DatacenterBroker extends SimEntity {
    ...
    public void bindCloudletToVm(int cloudletId, int vmId) {
        ((Cloudlet) Objects.requireNonNull(CloudletList.getById(getCloudletList(), cloudletId))).setVmId(vmId);
    }
    ...
    protected void processVmCreate(SimEvent ev) {
        ...
        if (getVmsCreatedList().size() == getVmList().size() - getVmsDestroyed()) {
            ...
            if (getVmsRequested() == getVmsAcks()) {
                ...
                if (!getVmsCreatedList().isEmpty()) { // if some vm were created
                    submitCloudlets();
    ...
    protected void processCloudletReturn(SimEvent ev) {
        ...
        if (getCloudletList().isEmpty() && cloudletsSubmitted == 0) { // all cloudlets executed
            ...
            if (!getCloudletList().isEmpty() && cloudletsSubmitted == 0) {
                ...
                // It means that some bound cloudlet is waiting for its VM to be created
                clearDatacenters();
    ...
    protected void submitCloudlets() {
        ...
        // remove submitted cloudlets from a waiting list
     ...
     *
     * @param <T> the generic type
     * @return the cloudlet received a list
     */
    @SuppressWarnings("unchecked")
     ...
     *
     * @param <T>            the generic type
     * @param vmsCreatedList the vms created a list
     */
