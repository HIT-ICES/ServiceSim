...
public class NetworkCloudletTimeSharedScheduler extends NetworkCloudletScheduler {


    public NetworkCloudletTimeSharedScheduler() {
        super();
    }
        ...
        for (ResCloudlet rcl : getCloudletExecList()) {
            ...
            if ((cl.currStageNum != -1)) {
                ...
                if (st.type == NetworkConstants.EXECUTION) {
                    ...
                    Log.printLine("------------------" + "  " + cl.getCloudletId() + "  " + cl.timeSpentInStage + "  " + cl.timeToStartStage);
