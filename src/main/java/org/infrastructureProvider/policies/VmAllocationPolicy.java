...
/**
 * VmAllocationPolicy is an abstract class that represents the provisioning policy of hosts to virtual machines in a
 * Datacenter.
 * It supports two-stage commit of reservation in hosts: first, we reserve the host and, once committed by the user, it
 * is effectively allocated to he/her
 *
...
public abstract class VmAllocationPolicy {
    ...
    /**
     * Get the host which is executing the given VM belonging to the given user.
     *
     * @param vm the vm
