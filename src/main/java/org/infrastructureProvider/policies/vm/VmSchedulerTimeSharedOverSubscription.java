 ...
 * Over subscription results in performance degradation.
 *
...
public class VmSchedulerTimeSharedOverSubscription extends VmSchedulerTimeShared {
    ...
    /**
     * Allocate pes for vm.
     * The policy allows over-subscription.
     * In other words, the policy still allows the allocation of VMs that require more CPU capacity that is available.
     * Over subscription results in performance degradation.
    ...
    protected boolean allocatePesForVm(String vmUid, List<Double> mipsShareRequested) {
        ...
        // the request to the PEs capacity
    ...
    /**
     * This method recalculates the distribution of MIPs among VMs considering eventual shortage of MIPS
