...
/**
 * VmAllocationPolicySimple is a VmAllocationPolicy that chooses, as the host for a VM, the host
 * with fewer PEs in use.
 *
...
public class VmAllocationPolicySimple extends VmAllocationPolicy {
    ...
    /**
     * Gets the host executing the given VM belonging to the given user.
     *
     * @param vm the vm
