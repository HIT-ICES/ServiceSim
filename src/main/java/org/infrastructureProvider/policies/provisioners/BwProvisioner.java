 ...
 * the field available will always contain the amount of free bandwidth available for future
 * allocations.
 *
...
public abstract class BwProvisioner {
    ...
    public BwProvisioner(JSONObject config) {
        this(config.getLongValue("bw"));
    }
    ...
    /**
     * Releases BW used by an all VMs.
     *
     * @pre $none
     * @post none
     */
