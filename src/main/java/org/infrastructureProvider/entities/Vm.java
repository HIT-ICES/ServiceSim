 ...
 * VM has an owner, which can submit cloudlets to the VM to be executed
 *
...
public class Vm {
     ...
     * @param mips              the mips
     * @param numberOfPes       number of CPUs
    ...
    /**
     * Generate unique string identification of the VM.
     *
     ...
     * @return time predicted completion time of the earliest finishing cloudlet, or 0 if there are no
     * next events
     * @pre currentTime >= 0
     * @post $none
     */
    ...
    /**
     * Gets the ID of the owner in the VM.
     *
    ...
    /**
     * Checks if being instantiated.
     *
     * @return true, if being instantiated
     */
     ...
     * @param isInMigration is in migration
     */
