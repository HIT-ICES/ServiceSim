 ...
 *  Pe to virtual machines.
 *  A host is associated with a datacenter.
 *  It can host virtual machines.
 *
...
public class Host {
     ...
     * @return expected time of completion in the next cloudlet in all VMs in this host.
     * Double.MAX_VALUE if there are no future events expected in this host
     * @pre currentTime >= 0.0
     * @post $none
     */
     ...
     * NOTE: <tt>resName</tt> is used for debugging purposes, which is <b>ON</b> by default.
     * Use {@link #setFailed(boolean)} if you do not want this information.
     *
