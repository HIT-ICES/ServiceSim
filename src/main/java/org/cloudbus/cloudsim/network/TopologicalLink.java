...
/**
 * This class represents a link (edge) from a graph
 *
...
public class TopologicalLink {
     ...
     */
    private final float linkDelay;

    private final float linkBw;
    ...
    /**
     * return the link-delay of the defined link
     *
    ...
    /**
     * return the link-bw of the defined link
     *
     * @return the bw
     */
