...
/**
 * This class is just a file-reader for the special brite-format!
 * the brite-file is structured as followed: Node-section: NodeID, x-pos, y-pos, in-degree, out-degree, ASid, type
 * (router/AS)
...
public class GraphReaderBrite implements GraphReaderIF {
     ...
     * @throws IOException if a file is not found or not readable
     */
    @Override
    ...
    private void parseNodeString(String nodeLine) {
        ...
        // number of node parameters to parse (counts at line start)
        int parameters = 3;
        ...
        // NodeID, x-pos, y-pos, in-degree, out-degree, ASid, type(router/AS)
        ...
        // instance a new node-object with previous parsed parameters
