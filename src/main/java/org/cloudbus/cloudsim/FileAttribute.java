...
/**
 * A class for storing related information regarding a {@link gridsim.datagrid.File} entity.
 *
 * @author Uros Cibej
...
public class FileAttribute {
    ...
    private int checksum;          // check a sum

    private double lastUpdateTime; // last updated time (sec) - relative

    private long creationTime;     // creation time (ms) - absolute/relative
    ...
    public FileAttribute(String fileName, int fileSize) throws ParameterException {
        ...
        // Set the file creation time. This is an absolute time
    ...
    public int getFileSizeInByte() {
        ...
        // return size * 1,048,576; // 1e6 - more accurate
    }
     ...
     *
     * @param masterCopy a flag denotes <tt>true</tt> for a pass key or <tt>false</tt> for a
     *                   replica
     */
