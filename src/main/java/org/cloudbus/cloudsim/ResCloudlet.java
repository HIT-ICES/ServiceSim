 ...
 * keeps track of the time for all activities in the CloudResource for a specific Cloudlet. Before a
...
public class ResCloudlet {
    ...
    // The below attributes are only used by the SpaceShared policy.
    /**
    ...
    /**
     * Cloudlet execution start time.
     * This attribute will only hold the latest time since a Cloudlet can be canceled, paused or resumed.
     */
    ...
    /**
     * Allocates a new ResCloudlet object upon the arrival of a Cloudlet object.
     * Use this constructor to store reserved Cloudlets, i.e., Cloudlets that did reservation before.
     * The arriving time is determined by {@link gridsim.CloudSim#clock()}.
     *
     * @param cloudlet  a cloudlet object
     * @param startTime a reservation start time.
     *                  Can also be interpreted as starting time to execute this Cloudlet.
     * @param duration  a reservation duration time.
     *                  Can also be interpreted as how long to execute this Cloudlet.
     * @param reserveID  a reservation ID that owns this Cloudlet
     * @pre cloudlet != null
     * @pre startTime > 0
     * @pre duration > 0
     * @pre reserveID > 0
     ...
     */
    private void init() {
        // get the number of PEs required to run this Cloudlet
    ...
    public long getRemainingCloudletLength() {
        ...
        // Remaining Cloudlet length can't be a negative number.
        if (length < 0) {
            return 0;
        }
     ...
     * This method sets the final data of:
     * <ul>
    ...
    /**
     * Get unique string identification of the VM.
     *
     * @return string uid
     */
