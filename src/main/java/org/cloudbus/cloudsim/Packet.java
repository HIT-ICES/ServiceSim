...
public interface Packet {
    ...
    /**
     * Returns the ID of the source in this packet.
     *
     * @return source id
     * @pre $none
     * @post $none
     ...
     * <p>
     * By default, the service type is 0 (zero).
     * It depends on the packet scheduler to determine the priority of this service level.
     *
