...
public class ResCloudletList {
     ...
     * This method needs a combination of Cloudlet ID and User ID because each Cloud User might have exactly the same
     * Cloudlet Ids.
     *
     ...
     * @param userId     a User Id
     * @param list       the list
     * @return the index in this list of the first occurrence in the specified Cloudlet, or
