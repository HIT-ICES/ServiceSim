...
public class File {
    ...
    /**
     * Denotes that the type of this file is raw data
     */
    public static final int TYPE_RAW_DATA = 1;
    /**
     * Denotes that the type of this file is reconstructed data
     */
    public static final int TYPE_RECONSTRUCTED_DATA = 2;
    /**
     * Denotes that the type of this file is tag data
     */
     ...
     * @throws ParameterException This happens when one of the following scenarios occurs:
     *                            <ul>
    ...
    public File(File file) throws ParameterException {
        ...
        try {
            ...
            throw new ParameterException("File(): Error - file attribute is null.");
        }
        fileAttr.setMasterCopy(false);   // set this file to replica name = file.getName();
    }
     ...
     *
     * @return a clone of this file (as a pass key) or <tt>null</tt> if an error occurs
     */
     ...
     * Preferably use {@link gridsim.CloudSim#clock()} method.
     *
    ...
    /**
     * Checks whether this file is a pass key or replica
     *
     * @return <tt>true</tt> if it is a pass key or <tt>false</tt> otherwise
     */
    ...
    /**
     * Marks this file as a pass key or replica
     *
     * @param masterCopy a flag denotes <tt>true</tt> for pass key or <tt>false</tt> for a
     *                   replica
     */
     ...
     * This transaction time can be related to the operation of adding / deleting / getting this file on a resource's
     * storage.
     *
