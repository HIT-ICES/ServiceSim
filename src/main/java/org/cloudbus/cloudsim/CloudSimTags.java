...
public class CloudSimTags {
     ...
     * That is, one event of this type is enough for {@link CloudSimShutdown} to trigger the end of the simulation
     */
     ...
     * This tag will not be used for identification.
     */
    ...
    /**
     * Denotes a cloud resource to be registered.
     * This tag is normally used between {@link CloudInformationService} and CloudResource entities.
     */
    public static final int REGISTER_RESOURCE = BASE + 2;
    /**
     * Denotes a cloud resource to be registered, that can support reservation.
     * This tag is normally used between {@link CloudInformationService} and CloudResource entity.
     */
    public static final int REGISTER_RESOURCE_AR = BASE + 3;
    /**
     * Denotes a list of all hostList's, including the ones that can support reservation.
     * This tag is normally used between {@link CloudInformationService} and CloudSim entity.
     */
    public static final int RESOURCE_LIST = BASE + 4;
    /**
     * Denotes a list of hostList's that only supports reservation.
     * This tag is normally used between {@link CloudInformationService} and CloudSim entity.
     */
    public static final int RESOURCE_AR_LIST = BASE + 5;
    /**
     * Denotes cloud resource characteristics information.
    ...
    /**
     * Denotes cloud resource allocation policy.
     * This tag is normally used between CloudSim and CloudResource entity.
     */
    ...
    /**
     * Denotes a request to get the total number of free Processing Elements (PEs) in a resource.
     * This tag is normally used between CloudSim and CloudResource entity.
     */
    public static final int RESOURCE_NUM_FREE_PE = BASE + 9;
    /**
     * Denotes a request to record events for statistical purposes.
     * This tag is normally used between CloudSim and CloudStatistics entity.
     */
    ...
    /**
     * Denotes request for cloud resource characteristics information.
     * This tag is normally used between CloudSim and CloudResource entity.
     */
    public static final int RESOURCE_CHARACTERISTICS_REQUEST = BASE + 15;
    /**
     * Denotes the return of a Cloudlet to sender.
     ...
     */
    public static final int INFO_PKT_SUBMIT = NET_BASE + 5;
    /**
     * This tag is used to return the ping request to sender.
     */
    public static final int INFO_PKT_RETURN = NET_BASE + 6;
