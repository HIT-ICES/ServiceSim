 ...
 * finishes.
 * If you want to save data in log files, this is the method in which the corresponding code would be placed.
 * </ul>
 *
...
public abstract class SimEntity implements Cloneable {
     ...
     *
     * @param p The event selection predicate
     * @return The number of events canceled (0 or 1)
     */
     ...
     * This method does not check the entity's deferred queue.
     *
     * @param p The predicate to match
     */
    ...
    /**
     * This method is invoked by the {@link Simulation} class when the simulation is started.
    ...
    /**
     * This method is invoked by the {@link Simulation} before the simulation finishes.
     * If you want to save data in log files, this is the method in which the corresponding code would be placed.
     */
     ...
     * This is used when independent replications have been specified as an output analysis method.
     * Clones or backups of the entities are made at the beginning of the simulation to reset the entities for
     * each later replication.
     * The user should not call this method.
     *
     * @return A clone of the entity
     * @throws CloneNotSupportedException the clone didn't support exception
     */
    @Override
     ...
     * @param cloudSimTag a user-defined number representing the type of event/message
    ...
    /**
     * Gets the network delay associated to the scent of a message from a given source to a given
     * destination.
     *
