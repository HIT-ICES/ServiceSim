...
public class CloudSimTags {
     ...
     * This tag is normally used between CloudInformationService and CloudResource entity.
     */
    public static final int REGISTER_RESOURCE = BASE + 2;
    /**
     * Denotes a grid resource, that can support reservation, to be registered.
     * This tag is normally used between CloudInformationService and CloudResource entity.
     */
    public static final int REGISTER_RESOURCE_AR = BASE + 3;
    /**
     * Denotes a list of all hostList, including the ones that can support reservation.
     * This tag is normally used between CloudInformationService and CloudSim entity.
     */
    public static final int RESOURCE_LIST = BASE + 4;
    /**
     * Denotes a list of hostList that only support reservation.
     * This tag is normally used between CloudInformationService and CloudSim entity.
     */
    ...
    /**
     * Denotes a request to get the total number of free Processing Elements (PEs) from a resource.
     * This tag is normally used between CloudSim and CloudResource entity.
     */
    ...
    /**
     * Denotes a request to create a new VM in a Datacenter With acknowledgement information sent by
     * the Datacenter
     */
    ...
    /**
     * Denotes a request to destroy a new VM in a Datacenter
     */
    ...
    /**
     * Denotes a request to migrate a new VM in a Datacenter
     */
    public static final int VM_MIGRATE = BASE + 35;
    /**
     * Denotes a request to migrate a new VM in a Datacenter With acknowledgement information sent
     * by the Datacenter
     */
