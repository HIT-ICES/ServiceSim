 ...
 * The Cloud hostList tells their readiness to process Cloudlets by registering themselves
 * with this entity.
 * Other entities such as the resource broker can contact this class for resource discovery
 * service, which returns a list of registered resource IDs.
...
public class CloudInformationService extends SimEntity {
     ...
     * @post $none
     */
    public CloudInformationService(String name) {
        super(name);
    ...
    public void processEvent(SimEvent ev) {
        ...
        switch (ev.getTag()) {
            ...
            // A resource that can support Reservation
    ...
    /**
     * Gets the list of all CloudResource IDs, including hostList that support Reservation.
     *
     ...
     * These events are based on tags that are not mentioned in {@link #body()}
     * method.
     *
    ...
    protected void processOtherEvent(SimEvent ev) {
        ...
        Log.printLine("CloudInformationService.processOtherEvent(): " + "Unable to handle a request from "
