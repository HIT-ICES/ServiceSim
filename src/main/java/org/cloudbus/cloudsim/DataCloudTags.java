...
public final class DataCloudTags {
    ...
    /**
     * Denotes a result regarding a list of Replica Catalogue IDs.
     * This tag should be called from a Regional Data GIS to a sender Regional Data GIS.
     */
    public static final int INQUIRY_RC_RESULT = BASE + 5;
    /**
     * Denotes the submission of a DataCloudlet.
     * This tag is normally used between user and DataCloudResource entity.
     */
    public static final int DATA_CLOUDLET_SUBMIT = BASE + 6;
    ...
    /**
     * Requests for a primary file to be added to the local storage(s).<br>
    ...
    // /////////////////////////////////////////////////////////////////////
    /**
     * Sends the result of adding a primary file back to sender.<br>
    ...
    /**
     * Requests for a primary file to be deleted from the local storage(s).<br>
     * The format of this request is Object[2] = {String lfn, Integer senderID}.<br>
    ...
    // /////////////////////////////////////////////////////////////////////
    /**
     * Sends the result of deleting a primary file back to sender.<br>
     * The format of the reply is Object[2] = {String lfn, Integer resultID}.<br>
     ...
     * NOTE: This request only asks for one location only not all.
     */
     ...
     * The format of this request is Object[2] = {Filter, Integer senderID}.<br>
    ...
    /**
     * Denotes the request to register / add a primary file to the Replica Catalogue.<br>
    ...
    /**
     * Sends the result of registering a primary file back to sender.<br>
    ...
    /**
     * Denotes that primary file addition is successful
     */
    public static final int CTLG_ADD_MASTER_SUCCESSFUL = CTLG_BASE + 12;

    /**
     * Denotes that primary file addition is failed due to an unknown error
     */
    public static final int CTLG_ADD_MASTER_ERROR = CTLG_BASE + 13;

    /**
     * Denotes that primary file addition is failed due to the catalogue is full
     */
    ...
    /**
     * Denotes the request to deregister / delete a primary file from the Replica Catalogue.<br>
    ...
    /**
     * Sends the result of unregistering a primary file back to sender.<br>
     * The format of the reply is Object[2] = {String lfn, Integer resultID}.<br>
    ...
    /**
     * Denotes that primary file deletion is successful
     */
    public static final int CTLG_DELETE_MASTER_SUCCESSFUL = CTLG_BASE + 22;

    /**
     * Denotes that primary file deletion is failed due to an unknown error
     */
    public static final int CTLG_DELETE_MASTER_ERROR = CTLG_BASE + 23;

    /**
     * Denotes that primary file deletion is failed because the file does not exist in the catalogue
     */
    public static final int CTLG_DELETE_MASTER_DOESNT_EXIST = CTLG_BASE + 24;

    /**
     * Denotes that primary file deletion is failed because replica files are still in the catalogue.
    ...
    /**
     * Denotes the request to deregister / delete a replica file from the Replica Catalogue.<br>
     * The format of this request is Object[2] = {String lfn, Integer resourceID}.<br>
    ...
    /**
     * Sends the result of unregistering a replica file back to sender.<br>
     * The format of the reply is Object[2] = {String lfn, Integer resultID}.<br>
    ...
    /**
     * Denotes the request to modify an existing primary file information stored in the Replica
     * Catalogue.<br>
     * The format of this request is Object[3] = {String filename, FileAttribute attr, Integer
     * resID}.<br>
    ...
    /**
     * Sends the result of modifying a primary file back to sender.<br>
     * The format of the reply is Object[2] = {String lfn, Integer resultID}.<br>
    ...
    /**
     * Denotes that primary file modification is failed due to an unknown error
     */
    public static final int CTLG_MODIFY_MASTER_ERROR = CTLG_BASE + 53;

    /**
     * Denotes that primary file modification is failed because the file does not exist in the
     * catalogue
     */
    public static final int CTLG_MODIFY_MASTER_ERROR_DOESNT_EXIST = CTLG_BASE + 54;

    /**
     * Denotes that primary file modification is failed because the file attribute is set to a
     * read-only
     */
