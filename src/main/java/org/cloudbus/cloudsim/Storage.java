...
public interface Storage {
     ...
     * The time taken (in seconds) for adding the specified file can also be found using
     ...
     * The time taken (in seconds) for getting the specified file can also be found using
     * {@link gridsim.datagrid.File#getTransactionTime()}.
     *
     ...
     * The time taken (in seconds) for deleting the specified file can be found using
     * {@link gridsim.datagrid.File#getTransactionTime()}.
     *
    ...
    /**
     * Removes a file from the storage.
     * The time taken (in seconds) for deleting the specified file can also be found using
     * {@link gridsim.datagrid.File#getTransactionTime()}.
     *
     * @param fileName the name of the file to be removed
     ...
     * The time taken (in seconds) for renaming the specified file can also be found using
     * {@link gridsim.datagrid.File#getTransactionTime()}.
     *
