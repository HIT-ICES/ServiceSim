...
public class PolicyConstants {
    ...
    public final static long VM_BW = 1000; // 1 M bit/s
    public final static long VM_SIZE = 250; // 0.25 GB, image size (MB)
    public final static int VM_CldScheduler = TimeShared; // 之前是timeshare
...
//    public static final double PacketArrivalProcess = 0.0001; // process time 0.001 s
//    public static final double RequestArrivalProcess = 0.0001; // process time 0.001 s
//    public static final double ResponseDataArrivalProcess = 0.0001; // process time 0.001 s
