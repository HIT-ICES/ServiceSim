...
public class BaseLuaLoader implements Closeable {
    ...
    public BaseLuaLoader() {
        path = null;
        params = new HashMap<>();
        L = getLua(LUA_JIT);
    }

    public BaseLuaLoader(LuaVersion version) {
        params = new HashMap<>();
        L = getLua(version);
    }

    public BaseLuaLoader(String path) {
        this.path = path;
        params = new HashMap<>();
        L = getLua(LUA_JIT);
    }

    public BaseLuaLoader(String path, LuaVersion version) {
        this.path = path;
        params = new HashMap<>();
        L = getLua(version);
    }
